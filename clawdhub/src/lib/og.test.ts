...
describe('og helpers', () => {
  ...
  it('builds soul metadata with summary', () => {
    ...
    expect(meta.title).toBe('North Star — NanoHub Souls')
  ...
  it('uses soul defaults when owner and summary are missing', () => {
    ...
    expect(meta.title).toBe('signal — NanoHub Souls')
    expect(meta.description).toMatch(/NanoHub Souls — the home for SOUL\.md/i)
