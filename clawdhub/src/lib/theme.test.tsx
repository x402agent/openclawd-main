...
describe('theme', () => {
  ...
  it('reads stored theme with fallback', () => {
    ...
    window.localStorage.setItem('nanohub-theme', 'dark')
    expect(getStoredTheme()).toBe('dark')
    window.localStorage.setItem('nanohub-theme', 'nope')
    expect(getStoredTheme()).toBe('system')
  ...
  it('useThemeMode persists and applies mode', async () => {
    ...
    expect(window.localStorage.getItem('nanohub-theme')).toBe('dark')
  })
})
