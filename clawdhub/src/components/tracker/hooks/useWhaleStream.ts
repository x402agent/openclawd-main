/**
 * useWhaleStream — WebSocket hook for whale trades (≥1 SOL) from PumpPortal/relay.
 */
...
function parsePumpPortal(msg: Record<string, unknown>, idRef: React.MutableRefObject<number>): WhaleEntry | null {
  ...
  if (raw !== undefined) solAmount = raw > 1e6 ? raw / 1e9 : raw
...
function parseRelay(msg: Record<string, unknown>, idRef: React.MutableRefObject<number>): WhaleEntry | null {
