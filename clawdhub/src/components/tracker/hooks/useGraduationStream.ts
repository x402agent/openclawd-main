/**
 * useGraduationStream — WebSocket hook for token graduation (migration to PumpSwap AMM).
 */
...
function parsePumpPortal(msg: Record<string, unknown>, idRef: React.MutableRefObject<number>): GraduationEntry | null {
...
function parseRelay(msg: Record<string, unknown>, idRef: React.MutableRefObject<number>): GraduationEntry | null {
