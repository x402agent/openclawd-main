...
import { ipfsGetRouterV1Handler, ipfsPostRouterV1Handler } from './httpApiV1/ipfsV1'
...
export const ipfsGetRouterV1Http = httpAction(ipfsGetRouterV1Handler)
export const ipfsPostRouterV1Http = httpAction(ipfsPostRouterV1Handler)
...
export const __handlers = {
  ...
  usersListV1Handler,
  ipfsGetRouterV1Handler,
  ipfsPostRouterV1Handler,
}
