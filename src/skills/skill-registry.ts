 ...
 *
 * Adapted from Clawd's src/skills/ (loadSkillsDir.ts, bundledSkills.ts, mcpSkillBuilders.ts)
 *
 ...
 *
 * The registry uses the same search/tag/capability patterns as Clawd's
...
// Adapted from Clawd's skill loading pattern
// ─────────────────────────────────────────────────────────────────────────────
...
// Adapted from Clawd's mcpSkillBuilders.ts (MCP → Skill conversion)
// ─────────────────────────────────────────────────────────────────────────────
