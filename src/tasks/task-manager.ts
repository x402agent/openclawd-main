 ...
 *
 * Adapted from Clawd's src/tasks/ (LocalShellTask, LocalAgentTask, DreamTask).
 *
...
export class TaskManager extends EventEmitter {
  ...
  // ── Handler registration (adapted from Clawd's task type dispatch) ──
  ...
  // ── Output streaming helpers (adapted from Clawd task output patterns) ──
...
// ─────────────────────────────────────────────────────────────────────────────
// Task Tool Definitions (mirrors Clawd's TaskCreateTool, etc.)
// ─────────────────────────────────────────────────────────────────────────────
