...
export const DESCRIPTION = 'Get or set Clawd configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Clawd configuration settings.

  View or change Clawd settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
