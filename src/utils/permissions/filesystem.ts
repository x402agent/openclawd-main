...
// Always ask when Clawd tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Clawd for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Clawd)
