...
/**
 * Resolve Clawd-specific path patterns for sandbox-runtime.
 *
 * Clawd uses special path prefixes in permission rules:
...
/**
 * Convert Clawd settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Clawd started)
