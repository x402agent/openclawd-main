...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Clawd was first started on this machine
  ...
  // Clawd usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Clawd OAuth token
  ...
  // Clawd hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
