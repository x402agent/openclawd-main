 ...
 *
 * Adapted from Clawd's src/bridge/ SSETransport + bidirectional message patterns.
 *
 ...
 * for reads and POST for writes — the same v2 "env-less" pattern from Clawd.
 *
 * Used by: Chrome Extension, Android app, macOS menu bar, web Control UI
 *
 * Key patterns from Clawd:
...
// ─────────────────────────────────────────────────────────────────────────────
// BoundedUUIDSet (adapted from Clawd's bridge dedup)
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Transport Message Types (aligned with Clawd's bridge protocol)
// ─────────────────────────────────────────────────────────────────────────────
...
// Control request types (from Clawd's bridge protocol)
...
export class GatewaySSETransport extends EventEmitter {
  ...
  handleInbound(raw: unknown, clientId: string): void {
    ...
    // Dedup (adapted from Clawd's BoundedUUIDSet replay guard)
  ...
  // ── Outbound message batching (adapted from Clawd bridge write batching) ──
...
// ─────────────────────────────────────────────────────────────────────────────
// Token refresh scheduler (adapted from Clawd's createTokenRefreshScheduler)
// ─────────────────────────────────────────────────────────────────────────────
