...
export class E2BDeployer {
    ...
    async deploy() {
        try {
            ...
            throw new Error(`E2B deployment failed: ${err.message}`);
        }
    }
    /**
    ...
    async connect(sandboxId) {
        try {
            ...
            throw new Error(`Failed to connect to sandbox: ${err.message}`);
        }
    }
    /**
     * Stop an E2B sandbox.
    ...
    async stop(sandboxId) {
        try {
            ...
            console.warn(`[E2B] Failed to stop sandbox: ${err.message}`);
        }
    }
}
/**
 ...
 */
export async function deployToE2B(config) {
