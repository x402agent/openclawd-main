    ...
    async deploy() {
        ...
        try {
            ...
            if (this.config.vaultPassphrase) {
                await execAsync(`echo "${this.config.vaultPassphrase}" | wrangler secret put VAULT_PASSPHRASE`, { cwd: tempDir, env: { ...process.env, CLOUDFLARE_API_TOKEN: this.config.apiToken } });
            }
            // Deploy
