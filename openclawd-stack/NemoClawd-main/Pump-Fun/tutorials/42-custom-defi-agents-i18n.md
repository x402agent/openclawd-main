# Tutorial 42: Custom DeFi Agent Definitions & i18n
...
Each agent is a JSON file that defines an AI persona — its expertise, personality, example interactions, and metadata. LLM platforms (Clawd, GPT, LobeChat) load these as pre-configured assistants.
...
- See [Tutorial 25](./25-defi-agents-integration.md) for loading agents into apps
- See [Tutorial 20](./20-mcp-server-ai-agents.md) for MCP server integration
- See [Tutorial 41](./41-plugin-gateway-api-handlers.md) for giving agents API tools
