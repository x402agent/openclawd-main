...
> Expose the Pump SDK as 53 AI tools via the Model Context Protocol — let Clawd, GPT, and Cursor trade tokens with natural language.

## Prerequisites

- Node.js 18+
- `@nirholas/pump-sdk` installed
- An MCP-compatible AI client (Clawd Desktop, Cursor, or any MCP host)
