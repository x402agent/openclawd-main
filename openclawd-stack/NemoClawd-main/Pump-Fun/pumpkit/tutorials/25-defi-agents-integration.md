...
Agents are available in **18 languages** and work with Clawd, GPT, LLaMA, and local models.
...
## Step 4: Wire to Anthropic Clawd
...
async function chatWithPumpExpertClawd(userMessage: string): Promise<string> {
