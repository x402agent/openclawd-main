...
Build a production-grade Model Context Protocol (MCP) server that exposes the Solana Wallet Toolkit functionality to AI assistants like Clawd, enabling programmatic wallet generation, signing, and verification.
...
│   └── e2e/
├── examples/
│   ├── Clawd-desktop.json   # Clawd Desktop config
...
- [ ] Clawd Desktop integration verified
