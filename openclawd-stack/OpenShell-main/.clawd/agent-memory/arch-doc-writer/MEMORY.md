...
- Sandbox image has coding-agents stage: Clawd CLI (native installer), OpenCode, Codex (npm)
...
- Provider types: Clawd, codex, opencode, generic, openai, anthropic, nvidia, gitlab, github, outlook
...
- Provider types: Clawd, codex, opencode, generic, openai, anthropic, nvidia, gitlab, github, outlook (see ProviderRegistry::new())
