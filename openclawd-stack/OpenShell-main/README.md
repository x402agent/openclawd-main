...
```bash
openshell sandbox create -- Clawd  # or opencode, codex, copilot
```
...
| Category   | Tools                                                    |
| ---------- | -------------------------------------------------------- |
| Agent      | `Clawd`, `opencode`, `codex`, `copilot`                 |
...
```bash
openshell sandbox create --gpu --from [gpu-enabled-sandbox] -- Clawd
```
...
| Agent                                                         | Source                                                                           | Notes                                                                         |
| ------------------------------------------------------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [Clawd](https://docs.anthropic.com/en/docs/Clawd-code) | [`base`](https://github.com/NVIDIA/OpenShell-Community/tree/main/sandboxes/base) | Works out of the box. Provider uses `ANTHROPIC_API_KEY`.                      |
