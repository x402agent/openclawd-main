...
A Clawd remote trigger (`trig_01KUywkkCQVJeqvzDbrK82Vj`) runs in Anthropic's
...
Manage: https://8bit.dev/code/scheduled/trig_01KUywkkCQVJeqvzDbrK82Vj
...
- `remote-trigger` — Clawd remote trigger
