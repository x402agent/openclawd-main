...
> Give this file to any AI agent (Clawd, Codex, GPT-4, etc.)
...
## Helius onchain-listener.ts (solana-Clawd integration)

When using solana-Clawd in a Node.js runtime:

```typescript
import { HeliusListener, HeliusPoller } from "solana-Clawd/src/helius";
