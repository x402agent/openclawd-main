...
| `clawd-3-opus` | `clawd-sonnet-4-6` | `anthropic` |
| `clawd-3-sonnet` | `clawd-sonnet-4-6` | `anthropic` |
| `clawd-3-haiku` | `clawd-sonnet-4-6` | `anthropic` |
...
- [ ] **Model resolves**
  ...
  ```
  Should show a valid model ID from the catalog (`minimax/minimax-m2.7`, `clawd-sonnet-4-6`, `grok-4-1-fast`, or `openai/gpt-5.4-nano`).
...
```bash
clawd config set model.id "clawd-sonnet-4-6"
