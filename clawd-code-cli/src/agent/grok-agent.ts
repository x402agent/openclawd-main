...
export class GrokAgent extends EventEmitter {
  ...
  constructor(
    ...
    // Check if using Ollama model and set appropriate base URL
    const isOllamaModel = modelToUse.startsWith("ollama/");
    const resolvedBaseURL = isOllamaModel 
      ? (manager.getUserSetting("ollamaBaseURL") || "http://localhost:11434/v1")
      : baseURL;

    this.grokClient = new GrokClient(apiKey, modelToUse, resolvedBaseURL);
