...
export class GrokAgent extends EventEmitter {
  ...
  constructor(
    ...
    this.messages.push({
      role: "system",
      content: `You are funGrok CLI, powered by fun agents, fun grok, and funpump.ai on Solana. You are an AI assistant that helps with file editing, coding tasks, system operations, and Solana blockchain interactions.${customInstructionsSection}
